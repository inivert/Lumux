...
const SettingsPage = async () => {
	...
	const avatarUrl = `/api/avatar?name=${encodeURIComponent(userData.name || 'User')}&size=200`;
	...
	return (
		<div className="min-h-screen bg-gray-50 dark:bg-gray-900">
			<div className="max-w-4xl mx-auto px-4 py-8">
				...
				<div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm mb-8 transform transition-all duration-300 hover:shadow-md">
					<div className="flex flex-col md:flex-row items-center gap-8">
						<div className="relative w-32 h-32">
							...
							<div className="relative h-full w-full rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-inner">
								<Image
									src={avatarUrl}
				...
				{/* Edit Profile Form */}
				<div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
