	...
	return (
		<section className='relative z-1 overflow-hidden bg-gray-1 py-17.5 dark:bg-black lg:py-22.5 xl:py-27.5'>
			...
			<SectionHeader
				...
				description='Hear what clients say about my personalized web development and maintenance services. Real success stories from businesses I've helped grow online.'
			/>
